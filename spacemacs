...
values."
  (setq-default
   ...
   '(
     ...
     csv
     ansible
     (haskell :variables haskell-enable-hindent-style "chris-done" haskell-completion-backend 'intero haskell-stylish-on-save t)
